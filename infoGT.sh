...
banner() {
printf "\n"
printf "\e[1;92m     .::.\e[0m\e[1;77m tooli zanyary darhenan - v1.0 \e[1;92m.::.\e[0m\n"
printf "\e[1;32m  .::.        Coded by #experts           .::.\e[0m\n"
printf "\n"
...
printf "\n"                                                                   |
printf "\e[1;92m[\e[0m\e[1;77m1\e[0m\e[1;92m]\e[1;93m pshknin bo e-mail\e[0m\n"
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m2\e[0m\e[1;92m]\e[1;93m pshknini site down yan na\e[0m\n"
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m3\e[0m\e[1;92m]\e[1;93m zanyari darhenan lasar IP\e[0m\n"
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m4\e[0m\e[1;92m]\e[1;93m dozinaway ip aw siteanay Cloudflare n\e[0m\n"
printf "\n"
read -p $'\e[1;92m[*] ZHMARAIAK HALL BZHERA: \e[0m' choice
...
printf "\n\e[1;43m[!] TKAYA DLLNIA BARAWA!\e[0m\n\n"
menu
fi
}
...
printf "\e[1;92m[*] siteaka haya!\e[0m\n"
else
printf "\e[1;93m[*] Siteaka nia!\e[0m\n"
fi
}
iptracker() {
...
read -p $'\e[1;92m[*] IPaka bnusa: \e[0m' ip_tracker
IFS=$'\n'
...
if [[ $hostnameip != "" ]]; then
printf "\e[1;92m[*] nawy hostaka:\e[0m\e[1;77m %s\e[0m\n" $hostnameip
fi
##
...
if [[ $reverse_dns != "" ]]; then
printf "\e[1;92m[*] DNS:\e[0m\e[1;77m %s\e[0m\n" $reverse_dns
fi
##


if [[ $continent != "" ]]; then
printf "\e[1;92m[*] NAWY kishwaraka:\e[0m\e[1;77m %s\e[0m\n" $continent
fi
##

country=$(grep -o 'Country:.*' iptracker.log | cut -d ">" -f3 | cut -d "&" -f1)
if [[ $country != "" ]]; then
printf "\e[1;92m[*] NAWY wlataka:\e[0m\e[1;77m %s\e[0m\n" $country
fi
##

state=$(grep -o "tracking lessimpt.*" iptracker.log | cut -d "<" -f1 | cut -d ">" -f2)
if [[ $state != "" ]]; then
printf "\e[1;92m[*] haremaka:\e[0m\e[1;77m %s\e[0m\n" $state
fi
##
city=$(grep -o "City Location:.*" iptracker.log | cut -d "<" -f3 | cut -d ">" -f2)

if [[ $city != "" ]]; then
printf "\e[1;92m[*] nawy sharaka:\e[0m\e[1;77m %s\e[0m\n" $city
fi
##
...
if [[ $as_number != "" ]]; then
printf "\e[1;92m[*] zanyari xataka:\e[0m\e[1;77m %s\e[0m\n" $as_number
fi
##

ip_speed=$(grep -o "IP Address Speed:.*" iptracker.log | cut -d "<" -f3 | cut -d ">" -f2)
if [[ $ip_speed != "" ]]; then
printf "\e[1;92m[*] xeray xataka:\e[0m\e[1;77m %s\e[0m\n" $ip_speed
fi
##
ip_currency=$(grep -o "IP Currency:.*" iptracker.log | cut -d "<" -f3 | cut -d ">" -f2)

if [[ $ip_currency != "" ]]; then
printf "\e[1;92m[*] jory PARAKAY:\e[0m\e[1;77m %s\e[0m\n" $ip_currency
fi
##
printf "\n"
rm -rf iptracker.log
...
read -p $'\e[1;92m[*] linki site: \e[0m' site
...
printf "\e[1;93m[!] aw site Cloudflare nia\e[0m\n"
fi
